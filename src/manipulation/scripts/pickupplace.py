...
class Manipulation(object):
    ...
    def pickup_cb(self, request):
        ...
        print "call object detection done"
        ...
        self.scene.add_box(table_name, table_pose, size=(table_info.width * 5, table_info.depth * 5, table_info.center.z))
