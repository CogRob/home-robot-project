...
class ActionClient(py_trees.behaviour.Behaviour):
    ...
    * Trigger true pre-emption by sending a new goal in :meth:`~py_trees_ros.actions.ActionClient.update()`
    ...
    def __init__(self, name="Action Client", action_spec=None, action_goal=None, action_namespace="/action",
                 override_feedback_message_on_running="running action"):
...
class FromBlackBoard(ActionClient):
    def __init__(self, name, blackboard_key, action_namespace="/action", action_spec=None, action_goal=None,
                 override_feedback_message_on_running="running action"):
...
class FromConstant(ActionClient):
    def __init__(self, name, action_namespace="/action", action_spec=None, action_goal=None,
                 override_feedback_message_on_running="running action"):
